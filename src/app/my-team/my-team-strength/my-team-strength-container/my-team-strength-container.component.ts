...
@Component({
  selector: 'app-my-team-strength-container',
  templateUrl: './my-team-strength-container.component.html',
  styleUrls: ['./my-team-strength-container.component.scss']
})
export class MyTeamStrengthContainerComponent implements OnChanges {
